"""用户域表：用户 + 用户偏好。"""
from sqlalchemy import Boolean, Column, Date, DECIMAL, ForeignKey, String, Table, Time, UniqueConstraint
...
user_preferences = Table(
    ...
    metadata,
    pk(),
    Column("user_id", ForeignKey("users.id"), nullable=False, comment="用户ID"),
    ...
    *ts_columns(),
    UniqueConstraint("user_id", name="uk_pref_user"),
    comment="用户偏好",
)
